...
function authUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 1 test register", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 2 test register for missing email / password", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 3: test register for existing email", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 4: test register user", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 5: test login for missing email / password", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 6: test login for incorrect password", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 7: test login for incorrect email", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 8: test for logout with no token", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app).get("/auth/logout");
            expect(response.statusCode).toEqual(401);
        }));
        test("TEST 9: test login for correct email and password", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app).post("/auth/login").send(user); //user logged in
            expect(response.statusCode).toEqual(200);
            // accessToken = response.body.accessToken;
            refreshToken = response.body.refreshToken;
        }));
        test("TEST 10: Test refresh token", () => __awaiter(this, void 0, void 0, function* () {
        ...
        test("TEST 11: test logout", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app).get("/auth/logout").set('Authorization', `JWT ${newRefreshToken}`);
            console.log("logout response:");
            console.log(response.text);
            expect(response.statusCode).toEqual(200);
        }));
        test("TEST 12: Test double use of refresh token", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app)
                .get("/auth/refresh")
                .set("Authorization", "JWT " + refreshToken)
                .send();
        ...
        test("TEST 13: no refresh token", () => __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, supertest_1.default)(app)
                .get("/auth/refresh")
                .send();
            expect(response.statusCode).not.toBe(200);
